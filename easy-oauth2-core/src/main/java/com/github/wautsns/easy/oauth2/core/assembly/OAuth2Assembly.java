 ...
 */
package com.github.wautsns.easy.oauth2.core.assembly;
...
public final class OAuth2Assembly {

    /** Logger. */
    private static final Logger log = LoggerFactory.getLogger(OAuth2Assembly.class);

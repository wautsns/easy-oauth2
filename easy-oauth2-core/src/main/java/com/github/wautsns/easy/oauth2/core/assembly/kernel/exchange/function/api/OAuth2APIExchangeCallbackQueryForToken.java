 ...
 */
package com.github.wautsns.easy.oauth2.core.assembly.kernel.exchange.function.api;
 ...
 */
@FunctionalInterface
public interface OAuth2APIExchangeCallbackQueryForToken<T extends AbstractOAuth2Token> {
    ...
    /**
     * Exchange callback query for token.
     *
     * @param query callback query
     * @return token
     * @throws OAuth2Exception if an oauth2 related error occurs
     */
    @NotNull T exchangeForToken(@NotNull OAuth2CallbackQuery query) throws OAuth2Exception;

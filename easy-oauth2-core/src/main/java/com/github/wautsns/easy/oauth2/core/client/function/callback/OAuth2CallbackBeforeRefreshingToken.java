...
/**
 * OAuth2 callback: before refreshing oauth2 token.
 *
 ...
 */
@FunctionalInterface
public interface OAuth2CallbackBeforeRefreshingToken<T extends AbstractRefreshableOAuth2Token> {

    /**
     * Do something before refreshing token.
     *
     * @param token token
     * @throws OAuth2Exception if an oauth2 related error occurs
     */
    void beforeRefreshingToken(@NotNull T token) throws OAuth2Exception;

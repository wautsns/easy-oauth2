 ...
 */
@FunctionalInterface
public interface OAuth2APIExchangeTokenForUser<T extends AbstractOAuth2Token, U extends AbstractOAuth2User> {
     ...
     */
    @NotNull U exchangeForUser(@NotNull T token) throws OAuth2Exception;
